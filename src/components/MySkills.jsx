...
const MySkills = () => {
  return (
    <div id="Skills" className="flex justify-center ">
      <div className="w-full xl:w-[1200px] mx-10 lg:mx-15 border-2 border-[#2a1ada]  pt-3 lg:pt-5 pl-3 lg:pl-5 pr-3 lg:pr-5 pb-8 lg:pb-16 rounded-md shadow-[0_0_20px_#2a1ada]  ">
        <h1 className="text-center text-3xl lg:text-5xl text-white font-bold  mt-4 lg:mt-8 mb-[50px] lg:mb-[150px]"> My Skills </h1>

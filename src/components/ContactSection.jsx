  ...
  return (
    <div id="Contact">
      ...
      <div className=" flex justify-center ">
        <div className="flex justify-center gap-4 lg:gap-8 mt-8 border-2 border-yellow-300 p-2 lg:p-10 rounded-xl max-w-fit  mx-4">
          <div className="flex justify-center items-center gap-2 lg:gap-4">
            ...
            <a
             ...
             className="!text-white hover:!text-green-500 text-[14px] lg:text-[32px]"
            >
              Example@gmail.com
            </a>
          </div>
